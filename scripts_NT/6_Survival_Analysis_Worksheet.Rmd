...
Okay, so the 84-miRNA signature in all patients together (males and females) is not significant - which is not suprising, as we did not actually get any oncofetal miRNAs in the unstratified approcah.  
...
p1 <- ggsurvplot(sfit_sex, 
           ...
           break.time.by = 3675/10,
           axes.offset = FALSE,
           palette = c("#845d91", "#ff9439", "#c2a1c6", "#ffb87f"),
           legend = "bottom",
           ggtheme = my_theme)
...
We'll investigate the survival of each of the 84 miRNAs separately now in males only, as we obtained these miRNAs from the male-stratified analysis,and check which of these are significany individually at predicting survival  
